...
require('./Futuro1.0.js')
nocache('../Futuro1.0.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./main.js')
...
require('./Futuro1.0')(XeonBotInc, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
